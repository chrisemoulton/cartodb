...
module.exports = cdb.core.View.extend({
  ...
  render: function() {
   ...
   _saveMap: function() {
        ...
        var emptyDatasetName = 'datalib2_tornados';//cdb.config.get('shared_empty_dataset_name');

        var layers = [];
        var datasets = window.datalib_layers;//['datalib2_tornados', 'datalib2_factories'];
