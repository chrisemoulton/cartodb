...
module.exports = BaseDialog.extend({
  className: 'Dialog Dialog-AddLayer is-opening',
  ...
  _initBinds: function() {
    this.model.bind('addLayerDone', this._addLayerDone, this);
    this.model.bind('change:contentPane', this._onChangeContentView, this);
    cdb.god.bind('importByUploadData', this._addLayerDone, this);
