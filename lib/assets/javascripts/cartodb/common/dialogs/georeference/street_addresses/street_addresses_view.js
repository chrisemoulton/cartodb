...
module.exports = cdb.core.View.extend({
  ...
  _renderHeader: function() {
    var titleHtml =
      'Select street address for <b>' +
      this.model.get('geocodeStuff').get('tableName') +
      '</b> to map data';

    var view = ViewFactory.createByTemplate('common/dialogs/georeference/default_content_header', {
      titleHtml,
      desc: 'If applicable, select country and state/province data associated with each address.'
    });
    this.addView(view);
