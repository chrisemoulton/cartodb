...
var presentAlias = require('../../common/view_helpers/alias_presenter');
...
module.exports = cdb.core.View.extend({
  ...
  render: function() {
    ...
    var url = vis.viewUrl(this.user, true);
    ...
    var d = {
      title:                   presentAlias({
                                 user: this.user,
                                 original: vis.get('name'),
                                 alias: vis.get('display_name') || vis.get('name_alias')
                               }),
      ...
      editable:                this.options.editable && !vis.get('from_external_source')
    };
    ...
    likesView.model.bind('change:likes', function() {
      vis.set('likes', likesView.model.get('likes') || 0);
    });
