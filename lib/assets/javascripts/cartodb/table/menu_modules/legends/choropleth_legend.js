...
cdb.admin.mod.ChoroplethLegend = cdb.admin.mod.CustomLegend.extend({
  ...
  _calculateItems: function() {
    ...
    var dataRange = this.wizardProperties.get('data_range');
    ...
    var leftLabelValue  = isLeftCustom ? this.model.get('items')[0].value : parseFloat((dataRange ? dataRange.min : this.metadata[0]) || 0, 10).toFixed(2);
