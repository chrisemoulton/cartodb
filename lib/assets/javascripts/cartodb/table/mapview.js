  ...
  _addBasemapDropdown: function() {
    ...
    if (!this.basemapDropdown) {
      ...
      if (this.vis.get("type") !== "table") {
        ...
        <a href="#" class="option-button dropdown chk_global_winds" title="Click to change background map"><div class="toggle"></div>Winds</a>');

        $(".map-options").append($options);

        var self = this;        
        $('.chk_global_winds').click(function(e){
