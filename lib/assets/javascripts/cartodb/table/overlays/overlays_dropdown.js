...
cdb.admin.OverlaysDropdown = cdb.ui.common.Dropdown.extend({
  ...
  _addTitleOverlay: function() {
    ...
    var defaultStyle = {
      ...
      "font-family-name": this._getDefaultFontFamilyName(),
      "box-padding":      10,
      "box-color":        "#000000",
      "box-opacity":      0,
  ...
  _getDefaultFontFamilyName: function() {
    var profAttrs = cdb.admin.ProfileAttributes.load(this.vis.user);
    var defaultFontFamilyName = profAttrs.get('defaultFontFamilyName');
    return defaultFontFamilyName ? defaultFontFamilyName : "Lato";
  },
