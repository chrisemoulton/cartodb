...
cdb.admin.models.Overlay = cdb.core.Model.extend({
  ...
  /**
   * Get the styles for this overlay as an object
   * of css properties and associated values.
   */
  getStyles: function () {
...
cdb.admin.Overlays = Backbone.Collection.extend({
  ...
  _createHeaderOverlay: function(property) {
    ...
    if (property === "title") {
      fontSize = profAttrs.get("defaultFixedTitleFontSize") || "20";
      opacity = profAttrs.get("defaultFixedTitleOpacity") || "0.7";
    }
    else {
      fontSize = profAttrs.get("defaultFixedDescriptionFontSize") || "12";
      opacity = profAttrs.get("defaultFixedDescriptionOpacity") || "0.7";
    }

    var fontFamilyName = profAttrs.get("defaultFontFamilyName") || "Helvetica";
