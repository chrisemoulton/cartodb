  ...
  var Table = cdb.core.View.extend({
   ...
   _saveTitleAlias: function (value) {
    ...
    _enableDisableExportTable: function(workView) {
        ...
        var exportImageDisabled = $.inArray('disable_export_image', user_data.feature_flags) !== -1;
        if (workView === 'map' && exportImageDisabled) {
          this.header.$('a.share').addClass("disabled");
        }
        else if (workView === 'map' || exportable) {
